...
def main():
    ...
    try:
        ...
        lowest_date = historical_low["timestamp"]
        highest_date = historical_high["timestamp"]

        buy_gap = (
            (last_close - lowest_price)
            / lowest_price
        ) * 100
        ...
        if st.button("Dapatkan Prediksi"):
            ...
            st.subheader("📊 Analisis Harga Historis Yahoo Finance")
            ...
            with col2:
                ...
                st.metric(
                    ...
                    f"${highest_price:,.2f}/oz"
                )
            
                st.write(
                    highest_date.strftime("%d %B %Y")
                )
                st.markdown("### 📈 Posisi Harga Saat Ini")

                st.write(
                    f"Harga sekarang : ${last_close:,.2f}/oz"
                )
            if last_close <= lowest_price * 1.05:

                st.success(
                    f"""
            ### ✅ Waktu Sangat Baik Membeli
            
            Harga saat ini sangat dekat dengan harga terendah historis Yahoo Finance.
            ...
            Potensi kenaikan jangka panjang relatif lebih besar.
            """
                )
            
            elif last_close >= highest_price * 0.95:
            
                st.error(
                    f"""
            ### 💰 Waktu Sangat Baik Menjual
            
            Harga saat ini mendekati harga tertinggi historis.
            ...
            Momentum harga berada di area yang menguntungkan untuk realisasi keuntungan.
            """
                )
                ...
                st.info(
                    """
            Harga masih berada di area tengah historis.
            
            Belum merupakan titik beli maupun jual terbaik.
            
            Disarankan menunggu harga bergerak mendekati area support atau resistance historis.
            """
                )
            ...
            fig.add_hline(
                ...
                annotation_text="Harga Terendah Historis"
            ...
            fig.add_hline(
                ...
                annotation_text="Harga Tertinggi Historis"
